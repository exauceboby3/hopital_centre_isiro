            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" id="insert_form" action="ajouterMedecin.php">
                        ...
                        <label>Postnom</label>
                        <input type="text" name="postnom_m" id="postnom" class="form-control" />
                        <br/>
...
<div class="table-responsive" id="table_medecin">
    ...
    <table id="autoGeneratedID" role="grid" class="table table-striped table-bordered">
        ...
        <tr>
            ...
            <th id="postnom_m" role="gridcell">Postnom</th>
        ...
        while($donne=$r->fetch()){
            ...
            <tr>
                ...
                <td id="postnom_m" role="gridcell"><?php echo $donne['postnom_m'];?></td>
