...
export const bodySystemGroups = [
  {
    label: 'Signes généraux et constitutionnels',
    structures: [
  ...
  },
  {
    ...
    structures: [
      ...
      'Nausées',
      'Pyrosis ou brûlure gastrique',
      'Rectorragie ou sang rouge dans les selles',
      'Régurgitations',
      'Satiété précoce',
      'Vomissements',
    ],
  },
  {
    ...
    structures: [
      ...
      'Écoulement mammaire',
      'Masse mammaire',
      'Ménorragies ou règles abondantes',
      'Métrorragies ou saignement hors règles',
      'Prurit vulvaire',
      'Règles douloureuses',
      'Sécheresse vaginale',
  ...
  },
  {
    ...
    structures: [
      ...
      'Gencives gonflées',
      'Langue douloureuse ou anormale',
      'Mauvaise haleine',
      'Mobilité dentaire',
  ...
  },
  {
    ...
    structures: [
      ...
      'Éruption après aliment ou médicament',
      'Éternuements allergiques',
      'Gonflement du visage ou des lèvres',
      'Infections inhabituelles ou répétées',
      'Réaction allergique',
      'Rougeur oculaire allergique',
      'Urticaire',
    ],
  },
  {
  ...
  },
  {
    ...
    structures: [
      ...
      'Démangeaisons',
      'Éruption cutanée',
      'Lésion ou plaie cutanée',
      'Masse ou nodule cutané',
